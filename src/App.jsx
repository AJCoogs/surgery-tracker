  ...
  return (
    <div style={{ minHeight:"100vh", background:"linear-gradient(170deg, #0d0d1a 0%, #141428 40%, #1a1a30 100%)", color:"#e0e0f0", fontFamily:"'Lato','Segoe UI',sans-serif", position:"relative", overflow:"hidden" }}>
      ...
      <div style={{ textAlign:"center", padding:"8px 24px 24px", fontSize:10, color:"#3a3a50", fontFamily:"'IBM Plex Mono',monospace" }}>
        © 2026 Houston Methodist Hospital · Not a real tracker · Please don't sue us<br />"Leading Medicine" · Also leading in waiting room discomfort
      </div>
    </div>
  );
}
    ...
    <div style={{ minHeight:"100vh", background:"#0d0d1a", color:"#e0e0f0", fontFamily:"'Lato',sans-serif", padding:24 }}>
      <div style={{ maxWidth:500, margin:"0 auto" }}>
        ...
        <div style={{ background:"#1a1a2e", borderRadius:14, padding:20, border:"1px solid rgba(255,255,255,0.06)" }}>
          ...
          <div style={{ fontSize:11, color:"#6a6a80", marginBottom:12 }}>Reset the elapsed time counter to start from now.</div>
          <button onClick={() => onUpdate({ startTime: Date.now() })} style={{ padding:"8px 16px", background:"rgba(255,200,50,0.1)", color:"#d4c080", border:"1px solid rgba(255,200,50,0.2)", borderRadius:8, fontSize:12, fontWeight:700, cursor:"pointer" }}>⏱️ Reset Timer</button>
        </div>
      </div>
    </div>
  );
